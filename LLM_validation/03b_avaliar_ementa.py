...
MODELOS = [
    {"nome": "Llama 3.1 8B",      "slug": "llama31_8b",      "tipo": "ollama", "id": "llama3.1:8b"},
    {"nome": "Qwen 2.5 7B",       "slug": "qwen25_7b",       "tipo": "ollama", "id": "qwen2.5:7b"},
    {"nome": "Gemma 2 9B",        "slug": "gemma2_9b",       "tipo": "ollama", "id": "gemma2:9b"},
    {"nome": "Groq Llama 3.3 70B","slug": "groq_llama33_70b","tipo": "groq",   "id": "llama-3.3-70b-versatile"},
    {"nome": "Groq Qwen 3 32B",   "slug": "groq_qwen3_32b",  "tipo": "groq",   "id": "qwen/qwen3-32b"},
]
...
def parse_resposta(raw):
    ...
    try:
        ...
        return resultado.get("postura", "").upper(), resultado.get("justificativa", ""), None
...
def main():
    ...
    for modelo in MODELOS:
        ...
        for caso in casos:
            ...
            print_status(f"  {simbolo} {caso_id:<30} inferido: {postura:<8} ({elapsed}s)", cor)
            if erro:
    ...
    for modelo in MODELOS:
        ...
        ac_ementa = sum(1 for v in d_ementa.values() if v["acertou"]) / len(d_ementa) * 100
        ...
        if resumo_path.exists():
            ...
            ac_resumo = sum(1 for v in d_resumo.values() if v["acertou"]) / len(d_resumo) * 100
