...
def test_filtrar_chunks_ignora_abaixo_do_threshold_e_nao_limita_quantidade():
    ...
    chunks_brutos = [
        ScoredPoint(id="chunk-1", score=0.90, version=1, payload={"discurso_id": "disc-1", "data_discurso": 1000}),
        ScoredPoint(id="chunk-2", score=0.71, version=1, payload={"discurso_id": "disc-2", "data_discurso": 2000}),
        ScoredPoint(id="chunk-3", score=0.85, version=1, payload={"discurso_id": "disc-3", "data_discurso": 3000}),
        ScoredPoint(id="chunk-4", score=0.72, version=1, payload={"discurso_id": "disc-4", "data_discurso": 4000}),
        ScoredPoint(id="chunk-5", score=0.80, version=1, payload={"discurso_id": "disc-5", "data_discurso": 5000}),
        ScoredPoint(id="chunk-6", score=0.60, version=1, payload={"discurso_id": "disc-6", "data_discurso": 6000}),
    ]
...
def test_resolver_textos_combina_texto_com_score_e_ignora_itens_inexistentes():
    ...
    chunks_com_score = [
        ...
        {"id": "chunk-3", "score": 0.80, "discurso_id": "d-3", "data_discurso": 30},  # Faltando no Supabase
    ]
...
def test_pipeline_reutiliza_embedding_da_proposicao_em_cache():
    ...
    # Arrange
    votos_fake = [
        {"id": "voto-1", "proposicao_id": "prop-1", "politico_id": 101, "voto_oficial": "Sim"},
        {"id": "voto-2", "proposicao_id": "prop-1", "politico_id": 102, "voto_oficial": "Não"},
    ]
    
    tabela_votos_mock = MagicMock()
    tabela_votos_mock.select.return_value.is_.return_value.in_.return_value.range.return_value.execute.return_value.data = votos_fake
    tabela_votos_mock.update.return_value.eq.return_value.execute.return_value = MagicMock()
...
def test_pipeline_completo_vincula_votos_e_registra_etl_log():
    ...
    # Arrange
    votos_fake = [
        {"id": "voto-abc", "proposicao_id": "prop-x", "politico_id": 99, "voto_oficial": "Sim"}
    ]
