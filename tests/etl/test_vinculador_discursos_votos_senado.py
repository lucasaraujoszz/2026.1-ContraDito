...
def test_filtrar_chunks_ignora_abaixo_do_threshold_e_limita_tres():
    ...
    chunks_brutos = [
        ...
        ScoredPoint(id="chunk-2", score=0.74, version=1, payload={"discurso_id": "disc-2", "data_discurso": 2000}),
        ScoredPoint(id="chunk-3", score=0.85, version=1, payload={"discurso_id": "disc-3", "data_discurso": 3000}),
        ScoredPoint(id="chunk-4", score=0.76, version=1, payload={"discurso_id": "disc-4", "data_discurso": 4000}),
...
def test_resolver_textos_combina_texto_com_score_e_ignora_itens_inexistentes():
    ...
    chunks_com_score = [
        ...
        {"id": "chunk-3", "score": 0.80, "discurso_id": "d-3", "data_discurso": 30},  # Missing in Supabase
    ]
