...
def test_afinidades_politico_inexistente(client, mock_supabase):
    ...
    mock_query_politico.select.return_value.eq.return_value.execute.return_value = mock_politico_result
    ...
    def mock_table_routing_afinidades(tabela):
        ...
        if tabela == "camara_politicos":
            ...
            mock_builder.eq.return_value.execute.return_value.data = [
                {"id": 1, "nome_civil": "P1", "nome_urna": "P1", "partido": "PT", "cargo": "Deputado Federal", "estado": "DF", "status_mandato": "Ativo", "url_foto": "http://foto.jpg"}
            ]
            # execute for all politicos call
            mock_builder.execute.return_value.data = [
                {"id": 1, "nome_civil": "P1", "nome_urna": "P1", "partido": "PT", "cargo": "Deputado Federal", "estado": "DF", "status_mandato": "Ativo", "url_foto": "http://foto.jpg"},
                {"id": 2, "nome_civil": "P2", "nome_urna": "P2", "partido": "PT", "cargo": "Deputado Federal", "estado": "DF", "status_mandato": "Ativo", "url_foto": "http://foto.jpg"},
                {"id": 3, "nome_civil": "P3", "nome_urna": "P3", "partido": "PT", "cargo": "Deputado Federal", "estado": "DF", "status_mandato": "Ativo", "url_foto": "http://foto.jpg"}
            ]
            ...
            mock_target_result.data = [{"proposicao_id": f"P-{i}", "voto_oficial": "SIM"} for i in range(5)]
            
            # all votes query
            mock_all_result = MagicMock()
            mock_all_result.data = (
                [{"proposicao_id": f"P-{i}", "voto_oficial": "SIM", "politico_id": 2} for i in range(5)] +
                [{"proposicao_id": f"P-{i}", "voto_oficial": "NÃO", "politico_id": 3} for i in range(5)]
            )
...
def test_fidelidade_sucesso_calculo(client, mock_supabase):
    def mock_table_routing_fidelidade(tabela):
        ...
        if tabela == "camara_politicos":
            mock_builder = MagicMock()
            mock_builder.eq.return_value.execute.return_value.data = [
                {"id": 1, "nome_civil": "P1", "nome_urna": "P1", "partido": "PT", "cargo": "Deputado Federal", "estado": "DF", "status_mandato": "Ativo"}
            ]
            mock_query.select.return_value = mock_builder
        elif tabela == "camara_votos":
            mock_builder_votos = MagicMock()
            ...
            mock_target_result.data = [
                {"proposicao_id": "Prop-1", "voto_oficial": "SIM", "partido_na_epoca": "PT"},
                {"proposicao_id": "Prop-2", "voto_oficial": "SIM", "partido_na_epoca": "PT"},
                {"proposicao_id": "Prop-3", "voto_oficial": "NÃO", "partido_na_epoca": "PT"}
            ]
            
            mock_all_result = MagicMock()
            mock_all_result.data = [
                {"proposicao_id": "Prop-1", "voto_oficial": "SIM", "partido_na_epoca": "PT", "politico_id": 1},
                {"proposicao_id": "Prop-1", "voto_oficial": "SIM", "partido_na_epoca": "PT", "politico_id": 2},
                {"proposicao_id": "Prop-1", "voto_oficial": "SIM", "partido_na_epoca": "PT", "politico_id": 3},
                {"proposicao_id": "Prop-1", "voto_oficial": "SIM", "partido_na_epoca": "PT", "politico_id": 4},
                {"proposicao_id": "Prop-1", "voto_oficial": "SIM", "partido_na_epoca": "PT", "politico_id": 5},
                {"proposicao_id": "Prop-1", "voto_oficial": "NÃO", "partido_na_epoca": "PT", "politico_id": 6},
                
                {"proposicao_id": "Prop-2", "voto_oficial": "SIM", "partido_na_epoca": "PT", "politico_id": 1},
                {"proposicao_id": "Prop-2", "voto_oficial": "NÃO", "partido_na_epoca": "PT", "politico_id": 2},
                {"proposicao_id": "Prop-2", "voto_oficial": "NÃO", "partido_na_epoca": "PT", "politico_id": 3},
                {"proposicao_id": "Prop-2", "voto_oficial": "NÃO", "partido_na_epoca": "PT", "politico_id": 4},
                {"proposicao_id": "Prop-2", "voto_oficial": "NÃO", "partido_na_epoca": "PT", "politico_id": 5},
                {"proposicao_id": "Prop-2", "voto_oficial": "NÃO", "partido_na_epoca": "PT", "politico_id": 6},
                
                {"proposicao_id": "Prop-3", "voto_oficial": "NÃO", "partido_na_epoca": "PT", "politico_id": 1},
                {"proposicao_id": "Prop-3", "voto_oficial": "NÃO", "partido_na_epoca": "PT", "politico_id": 2},
                {"proposicao_id": "Prop-3", "voto_oficial": "NÃO", "partido_na_epoca": "PT", "politico_id": 3},
                {"proposicao_id": "Prop-3", "voto_oficial": "NÃO", "partido_na_epoca": "PT", "politico_id": 4},
                {"proposicao_id": "Prop-3", "voto_oficial": "NÃO", "partido_na_epoca": "PT", "politico_id": 5}
            ]
...
def test_polarizacao_proposicao_inexistente(client, mock_supabase):
    ...
    mock_query_prop.select.return_value.eq.return_value.execute.return_value = mock_result_prop
...
def test_polarizacao_sucesso_calculo(client, mock_supabase):
    def mock_table_routing_polarizacao(tabela):
        ...
        if tabela == "camara_proposicoes":
            mock_builder = MagicMock()
            mock_builder.eq.return_value.execute.return_value.data = [
                {"id": "Prop-1", "proposicao_id": "PL-123", "tipo": "PL", "numero": 123, "ano": 2026}
            ]
            mock_query.select.return_value = mock_builder
        elif tabela == "camara_votos":
            mock_builder_votos = MagicMock()
...
def test_coesao_partidos_sucesso(client, mock_supabase):
    ...
    mock_result_votos.data = [
        ...
        {"proposicao_id": "Prop-1", "voto_oficial": "SIM", "partido_na_epoca": "PT", "politico_id": 2},
        {"proposicao_id": "Prop-1", "voto_oficial": "SIM", "partido_na_epoca": "PT", "politico_id": 3},
        {"proposicao_id": "Prop-1", "voto_oficial": "NÃO", "partido_na_epoca": "PT", "politico_id": 4},
        
        {"proposicao_id": "Prop-1", "voto_oficial": "SIM", "partido_na_epoca": "PL", "politico_id": 5},
        {"proposicao_id": "Prop-1", "voto_oficial": "SIM", "partido_na_epoca": "PL", "politico_id": 6},
        {"proposicao_id": "Prop-1", "voto_oficial": "SIM", "partido_na_epoca": "PL", "politico_id": 7},
        {"proposicao_id": "Prop-1", "voto_oficial": "SIM", "partido_na_epoca": "PL", "politico_id": 8},
        
        {"proposicao_id": "Prop-2", "voto_oficial": "SIM", "partido_na_epoca": "PT", "politico_id": 1},
        {"proposicao_id": "Prop-2", "voto_oficial": "SIM", "partido_na_epoca": "PT", "politico_id": 2},
        {"proposicao_id": "Prop-2", "voto_oficial": "SIM", "partido_na_epoca": "PT", "politico_id": 3},
        {"proposicao_id": "Prop-2", "voto_oficial": "SIM", "partido_na_epoca": "PT", "politico_id": 4},
        
        {"proposicao_id": "Prop-2", "voto_oficial": "SIM", "partido_na_epoca": "PL", "politico_id": 5},
        {"proposicao_id": "Prop-2", "voto_oficial": "SIM", "partido_na_epoca": "PL", "politico_id": 6},
        {"proposicao_id": "Prop-2", "voto_oficial": "NÃO", "partido_na_epoca": "PL", "politico_id": 7},
        {"proposicao_id": "Prop-2", "voto_oficial": "NÃO", "partido_na_epoca": "PL", "politico_id": 8}
    ]
...
def test_listar_discursos_politico_inexistente(client, mock_supabase):
    ...
    mock_query = MagicMock()
    mock_query.select.return_value.eq.return_value.execute.return_value = mock_politico_result
    mock_supabase.table.return_value = mock_query
...
def test_listar_discursos_politico_sucesso(client, mock_supabase):
    ...
    mock_query_discursos.select.return_value.eq.return_value.order.return_value.range.return_value.execute.return_value = mock_discursos_result
